...
volatile long int data;

void animation(void)
{	
	Nokia5110_Clear();
	Nokia5110_SetCursor(0, 0);			   
	Nokia5110_OutString("Move Right");	   
	...
	if ((ADC1_RIS_R & (1<<3)) == (1<<3))
			...
			while(ADC1_SSFIFO3_R <= 4000)
			{
				if(ADC1_SSFIFO3_R <= 500)
				{
					Nokia5110_PrintBMP(0, 24, SmallEnemy10PointA, 0); 
					Nokia5110_DisplayBuffer();
					Timer2_delay(5);			
					Nokia5110_ClearBuffer();
				}
				else if(ADC1_SSFIFO3_R <= 1000)
				{
					Nokia5110_PrintBMP(10, 24, SmallEnemy10PointA, 0); 
					Nokia5110_DisplayBuffer();
					Timer2_delay(5);			
					Nokia5110_ClearBuffer();
				}
				else if(ADC1_SSFIFO3_R <= 1500)
				{
					Nokia5110_PrintBMP(20, 24, SmallEnemy10PointA, 0); 
					Nokia5110_DisplayBuffer();
					Timer2_delay(5);			
					Nokia5110_ClearBuffer();
				}
				else if(ADC1_SSFIFO3_R <= 2000)
				{
					Nokia5110_PrintBMP(30, 24, SmallEnemy10PointA, 0); 
					Nokia5110_DisplayBuffer();
					Timer2_delay(5);			
					Nokia5110_ClearBuffer();
				}
				else if(ADC1_SSFIFO3_R <= 2500)
				{
					Nokia5110_PrintBMP(40, 24, SmallEnemy10PointA, 0); 
					Nokia5110_DisplayBuffer();
					Timer2_delay(5);			
					Nokia5110_ClearBuffer();
				}
				else if(ADC1_SSFIFO3_R <= 3000)
				{
					Nokia5110_PrintBMP(50, 24, SmallEnemy10PointA, 0); 
					Nokia5110_DisplayBuffer();
					Timer2_delay(5);			
					Nokia5110_ClearBuffer();
				}
				else if(ADC1_SSFIFO3_R <= 3500)
				{
					Nokia5110_PrintBMP(60, 24, SmallEnemy10PointA, 0); 
					Nokia5110_DisplayBuffer();
					Timer2_delay(5);			
					Nokia5110_ClearBuffer();
				}
			...
			Nokia5110_Clear();
			//data =500 - (data/8);			 //0 - 3.3   0-500
			//if(data == 0) break;
			//x += data; //x coordinate
			//Nokia5110_PrintBMP(x, 24, SmallEnemy10PointA, 0); 
			//Nokia5110_DisplayBuffer();
			//Timer2_delay(5);			
			//Nokia5110_ClearBuffer(); 
			//Nokia5110_PrintBMP(0, 24, SmallEnemy10PointA, 0); 
